...
public abstract class AbstractPath2<T extends Comparable<T>> implements Path<T>
{
	...
	protected AbstractPath2()
	{
		this(null, null);
	}

	protected AbstractPath2(T lastStep)
	{
		this(null, lastStep);
	}

	protected AbstractPath2(Path<T> parent, T lastStep)
	{
		super();
		this.parent=parent;
	...
	public boolean equals(Object obj)
	{
		...
		if (!(obj instanceof AbstractPath2))
		{
			return false;
		}
		@SuppressWarnings("unchecked")
		AbstractPath2<T> other=(AbstractPath2<T>)obj;
		if (this.tailStep == null)
		{
	...
	protected abstract Path<T> createFromSingleStep(T step);
